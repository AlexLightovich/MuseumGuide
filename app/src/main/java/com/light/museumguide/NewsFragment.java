...
public class NewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        map.put("Zag","ЗАГОЛОВОК");
        map.put("Date", "13.04.19");
        map.put("News","НОВОСТЬ 1");
        list1.add(map);
        ...
        list1.add(map3);
        SimpleAdapter simpleAdapter = new SimpleAdapter(view.getContext(), list1, R.layout.news_view_layout, new String[]{"Zag","Date", "News"}, new int[]{R.id.textZagol,R.id.textDate,R.id.textNews});
